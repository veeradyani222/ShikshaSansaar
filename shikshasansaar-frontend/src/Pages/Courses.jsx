...
import Loading from "../Components/assets/pro-library-loading.json"; // Replace with the path to your loading animation JSON file.
...
const Courses = () => {
  ...
  const getNormalizedCategory = (category) => {
    return categoryMap[category.toLowerCase()] || category;
      ...
      const [normalizedCategory, setNormalizedCategory] = useState(getNormalizedCategory('CA Final'));
  ...
  useEffect(() => {
      ...
      }, [normalizedCategory,selectedSubCategory, selectedFaculties, selectedSubjects, selectedBatchType, selectedLectureDuration, all_products]);
